...
import { getCollectionRecord, exportCollectionRecord } from '@/api/collectionManagement'
...
export default {
  ...
  methods: {
    ...
    async getTableList(isSearch) {
      ...
      const res = await getCollectionRecord(tmp)
    ...
    async exportData() {
      ...
      const res = await exportCollectionRecord(tmp)
      ...
      fileReader.onload = (event) => {
        ...
        a.download = `collection_record_${nowStr}.xlsx`
